...
#     schd.add_holiday('2021-12-18', 'Finals')
    ...
    schd.add_content(content('lecture', 'Group A: Temp. Sensors and Computer Analysis', newtopic=True, link='TempSensors/temp_sensors_main.ipynb'))
    ...
    schd.add_content(content('lecture', 'Group A: Gas Phase Kinetics Part 1', newtopic=True))
    schd.add_content(content('lecture', 'Group A: Gas Phase Kinetics Part 2'))
    schd.add_content(content('lecture', 'Group B: Gas Phase Kinetics Part 1'))
    schd.add_content(content('lecture', 'Group B: Gas Phase Kinetics Part 1'))
    
    schd.add_content(content('lecture', 'Group A: Joule Thomson Part 1', newtopic=True))
    schd.add_content(content('lecture', 'Group A: Joule Thomson Part 2'))
